				...
				<div>
					<div id="left">
    					...
    					<div id='coffee-login-div'>
    						<br />
    						<form name='coffee-login-form' id='coffee-login-form'>
								  ...
								  <a class="btn btn-success" href="#"><i class="icon-caret-right"></i>&nbsp;&nbsp;&nbsp;Go</a>
							</form>
    					</div>    					
    					<div id='coffee-register-div'>
    						<br />
    						<form name='coffee-register-form' id='coffee-register-form'>
  								<div class="input-prepend">
								...
								<div class="input-prepend">
								    <span class="add-on"><i class="icon-key"></i></span>
								    <input class="span2" type="password" placeholder="Re-enter Password">
								</div>
								<a class="btn btn-success" href="#"><i class="icon-caret-right"></i>&nbsp;&nbsp;&nbsp;Go</a>
							</form>
    					</div>
