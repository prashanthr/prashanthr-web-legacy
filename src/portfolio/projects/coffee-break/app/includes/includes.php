...
$preCoffeeURI = "$verifyLogin";

$titleArray = array("Home" => "Coffee Break - Home", "Dashboard" => "Coffee Break - Dashboard", "Desk" => "Coffee Break - Desk", "Account" => "Coffee Break - Account", "Help" => "Coffee Break - Help", "Technology" => "Coffee Break - Technology", "Setup" => "Coffee Break - Setup", "Terms" => "Coffee Break - Terms and Conditions", "Credits" => "Coffee Break - Credits", "Level" => "Coffee Break - Level", "Login" => "Coffee Break - Login", "Notes" => "Coffee Break - Notes");
