        			...
        			if (xmlhttp.readyState==4 && xmlhttp.status==200)
	 			    {
						...
						j = 0;
						for (var i = 14; i < window.responseStringArray.length; i++) {
						            				window.piArray[j] = parseFloat (window.responseStringArray[i]);						            				
						            				j++;
						            			};
            			...
            			window.chart.series[2].setData([window.piArray[0], window.piArray[1], window.piArray[2], window.piArray[3], window.piArray[4], window.piArray[5], window.piArray[6] ]);
